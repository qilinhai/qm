...
function Lunar(){
 ...
 this.yueLiHTML=function(By,Bm,curJD){
  ...
  for(i=0;i<this.dn;i++){
    ...
    if(ob.jqmc){
    		if(b4 == ""){
    				//格式：白露:2017年9月 7日 18:38:34
    				b4 = ob.jqmc + ":" + ob.y + "年" + ob.m + "月" + c +'日 ' + ob.jqsj;
    				var cunrentJeiQiName = ob.jqmc;
    				if(ob.m<10){
				    	 ob.m='0'+ob.m;
				    }
    				var cunrentJeiQiYear = ob.y;
    				var cunrentJeiQiMonth = ob.m;
    				var cunrentJeiQiDay = c;
    				var cunrentJeiQiTime = ob.jqsj;
    		}
    }
  }
  this.pg2 = b2+'<br>'+b3+'<br>'+b4;
  //节气名称,年份，月份，日，时间
  this.cunrentJeiQiName = cunrentJeiQiName;
  this.cunrentJeiQiYear = cunrentJeiQiYear;
  this.cunrentJeiQiMonth = cunrentJeiQiMonth;
  this.cunrentJeiQiDay = cunrentJeiQiDay;
  this.cunrentJeiQiTime = cunrentJeiQiTime;
 };
}
